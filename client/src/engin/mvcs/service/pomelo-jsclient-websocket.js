...
function requires(name) {
    var module = requires.modules[name];
    if (!module) throw new Error('failed to requires "' + name + '"');
...
requires.register = function (name, definition) {
...
requires.define = function (name, exports) {
    requires.modules[name] = {
        exports: exports
    };
};
requires.register("pomelonode~pomelo-protobuf@master", function (exports, module) {
                ...
                switch (proto.option) {
                    case 'required' :
                        if (typeof(msg[name]) === 'undefined') {
                            ...
                            cc.log('warn: no property exist for required! name: %j, proto: %j, msg: %j', name, proto, msg);
                            return false;
                        }
                    case 'optional' :
                        if (typeof(msg[name]) !== 'undefined') {
                            ...
                            if (!!message && !checkMsg(msg[name], message)) {
                                cc.log('warn: inner proto error! name: %j, proto: %j, msg: %j', name, proto, msg);
                                return false;
                            }
                        }
                        break;
...
requires.register("component~emitter@master", function (exports, module) {
...
requires.register("netease~pomelo-protocol@master", function (exports, module) {
...
requires.register("pomelonode~pomelo-jsclient-websocket@master", function (exports, module) {
    (function () {
        ...
        var connect = function (params, url, cb) {
            ...
            var onclose = function (event) {
                ...
                //cc.log('warn: socket error: '+event.toString());
        ...
        var heartbeatTimeoutCb = function () {
            ...
            if (gap > gapThreshold) {
                ...
                cc.log('warn: server heartbeat timeout');
...
requires.register("./local\boot", function (exports, module) {
    var Emitter = requires("component~emitter@master");
    window.EventEmitter = Emitter;

    var protocol = requires("netease~pomelo-protocol@master");
    window.Protocol = protocol;

    var protobuf = requires("pomelonode~pomelo-protobuf@master");
    window.protobuf = protobuf;

    var pomelo = requires("pomelonode~pomelo-jsclient-websocket@master");
